...
import org.rho.converter.controllers.Controller;
...
public class Section extends JPanel {
    ...
    private void initializeSection() {
        ...
        dataTo.setToolTipText("Select the unit to convert to");
        ...
        copyResultBtn.setText("Copy to Clipboard!");
        copyResultBtn.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        copyResultBtn.setBounds(336, 300, 200, 32);
        add(copyResultBtn);
    ...
    private void copyResult() {
        ...
        if (!toCopy.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Value Copied", "Copied", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Empty Value.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
